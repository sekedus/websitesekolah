...
<form action="<?php echo base_url('admin/kategori_client') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
<?php 
echo csrf_field(); 
?>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<input type="text" name="nama_kategori_client" class="form-control" placeholder="Nama kategori client" value="<?php echo set_value('nama_kategori_client') ?>" required>
