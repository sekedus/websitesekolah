...
<form action="<?php echo base_url('admin/kategori_agenda') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
<?php 
echo csrf_field(); 
?>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<input type="text" name="nama_kategori_agenda" class="form-control" placeholder="Nama kategori agenda" value="<?php echo set_value('nama_kategori_agenda') ?>" required>
					</div>
					<div class="col-3">
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<input type="number" name="urutan" class="form-control" placeholder="Nomor urut tampil kategori agenda" value="<?php echo set_value('urutan') ?>">
					</div>
				</div>
