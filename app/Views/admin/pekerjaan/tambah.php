...
<?php 
echo form_open(base_url('admin/pekerjaan')); 
echo csrf_field(); 
?>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<input type="text" name="nama_pekerjaan" class="form-control" placeholder="Nama pekerjaan" value="<?php echo set_value('nama_pekerjaan') ?>" required>
					</div>
				</div>
