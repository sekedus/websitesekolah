...
<table class="table table-bordered table-sm" id="example3">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="<?php echo base_url('admin/kategori_fasilitas/edit/'.$kategori_fasilitas->id_kategori_fasilitas) ?>" class="btn btn-secondary btn-xs mb-1"><i class="fa fa-edit"></i></a>
				<a href="<?php echo base_url('admin/kategori_fasilitas/delete/'.$kategori_fasilitas->id_kategori_fasilitas) ?>" class="btn btn-secondary btn-sm delete-link"><i class="fa fa-trash"></i></a>
			</td>
		</tr>
		<?php $no++; } ?>
	</tbody>
