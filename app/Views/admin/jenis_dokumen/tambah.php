...
<form action="<?php echo base_url('admin/jenis_dokumen') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
<?php 
echo csrf_field(); 
?>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<input type="text" name="nama_jenis_dokumen" class="form-control" placeholder="Nama jenis dokumen pendaftaran" value="<?php echo set_value('nama_jenis_dokumen') ?>" required>
