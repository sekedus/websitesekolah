	...
	<div class="col-md-6">
		...
		<div class="input-group">
          ...
          <span class="input-group-append">
            ...
            <a href="<?php echo base_url('admin/cabang/tambah') ?>" class="btn btn-info">
		...
		<tr>
          ...
          <label for="check_<?php echo $no ?>"></label>
			...
			<td class="btn-group">
				...
				<a href="<?php echo base_url('admin/cabang/delete/'.$cabang->id_cabang) ?>" class="btn btn-secondary btn-xs mt-1 delete-link" title="Hapus"><i class="fa fa-trash"></i></a>
			</td>
		</tr>
		<?php $no++; } ?>
	</tbody>
